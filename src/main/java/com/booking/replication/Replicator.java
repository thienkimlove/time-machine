            ...
            if (configuration.getStartingBinlogFileName() != null) {
                ...
                if ( safeCheckPoint != null ) {
                    ...
                    if (pseudoGTID != null) {
                        ...
                        BinlogCoordinatesFinder coordinatesFinder = new BinlogCoordinatesFinder(replicantActiveHost,configuration.getReplicantPort(),configuration.getReplicantDBUserName(),configuration.getReplicantDBPassword());
